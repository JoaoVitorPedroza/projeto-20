...
exports.findByClientDocument = findByClientDocument;
exports.deleteByPhoneNumber = deleteByPhoneNumber;
var index_1 = __importDefault(require("../database/index"));
function createPhone(phoneData) {
    return __awaiter(this, void 0, void 0, function () {
        var clientDocument, phoneNumber, carrierName, name, description, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    clientDocument = phoneData.clientDocument, phoneNumber = phoneData.phoneNumber, carrierName = phoneData.carrierName, name = phoneData.name, description = phoneData.description;
...
function findByClientDocument(clientDocument) {
    return __awaiter(this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
exports.phoneRepository = {
    ...
    findByClientDocument: findByClientDocument,
    deleteByPhoneNumber: deleteByPhoneNumber,
};
