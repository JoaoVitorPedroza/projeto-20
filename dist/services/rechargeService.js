        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    phone = _a.sent();
                    if (!phone) {
                        throw new errors_1.NotFoundError('Telefone não encontrado. Não é possível listar as recargas.');
                    }
...
function createRecharge(rechargeData) {
    return __awaiter(this, void 0, void 0, function () {
        var phoneNumber, amount, phone, recordData, newRecharge;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    phone = _a.sent();
                    if (!phone) {
                        throw new errors_1.NotFoundError('Telefone não cadastrado. Não é possível realizar a recarga.');
                    }
                    recordData = {
                        phoneId: phone.id,
                        amount: amount,
                    };
                    return [4 /*yield*/, rechargeRepository_1.rechargeRepository.createRecharge(recordData)];
                case 2:
                    newRecharge = _a.sent();
                    return [2 /*return*/, newRecharge];
            }
        });
    });
}
function getSummary() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, rechargeRepository_1.rechargeRepository.getRechargesSummary()];
        });
    });
}
